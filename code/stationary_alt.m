...
% Like the main code, it fixes the output price p and solves the free-entry
% condition for the wage w given a hardcoded entry cost ce (the explicit-
% price analogue of the original "solve for zstar"). z = p/w is recovered
% afterwards.
...
% p, w, z: output price, wage, and relative price z = p/w
...
% MAIN CHANGE: Take ce as given, fix the output price p and solve the
% free-entry condition for the wage w (the recoded, explicit-price analogue
% of the original "solve for zstar"). z = p/w is recovered afterwards.
w = solve_wage(params) ;
params.w = w ;
